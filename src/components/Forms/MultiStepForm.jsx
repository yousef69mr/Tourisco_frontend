              ...
              <Box sx={{ mt: 1, mb: 1 }} key={index}>
                <Box>
                  <Typography variant="h4" className="text-color">
                    {t(`${formName}.steps.${activeStep}.fields.${index}.label`)}
                  </Typography>
                  <Button
                      ...
                      {fields.map((input, j) => (
                        <Container sx={{ mt: 1, mb: 1 }} key={j}>
                          <FormikController
                            ...
                            helperText={
                              input.helperText &&
                              `${formName}.steps.${activeStep}.fields.${index}.fields.${j}.helperText`
                            }
                            options={input.options && input.options}
                            placeholder={
                              input.placeholder &&
                              t(
                                `${formName}.steps.${activeStep}.fields.${index}.fields.${j}.placeholder`
                              )
                            }
                            // firstoption={
                            //   firstOption
