...
function LandmarkEvent({ id }) {
  ...
  const ticket = tickets.find((ticket) => ticket.ticket.event.id === event.event.id);
      ...
      <div className={css.item}>
        ...
        <div className={css.item_left}>
          ...
          <div className={css.sce}>
            ...
            <p> {t("LandmarkEvent.From")} {event.event.openTime}{t("LandmarkEvent.AM")} 
            <span> {t("LandmarkEvent.To")} {event.event.closeTime}{t("LandmarkEvent.PM")}
             </span></p>
  ...
  .map((ticket) => (
    <div key={ticket.id}>
       {ticket.ticket_class_category}: {ticket.ticket.price}{t("LandmarkEvent.EG")}
    </div>
  ))}
</div>
          </div>
