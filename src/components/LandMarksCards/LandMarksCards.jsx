...
{/*console.log(landmarks)*/}
  ...
  const filteredLandmarks = filterLandmarks(landmarks, selectedCategory,
     searchQuery, activeOnly, ratingRange,searchQuerycategory);
  ...
  return (
    <div className={css.landmarkbodyy}>
      ...
      {selectedCategory ? <h2>
        {categories.find((category) => category.category.id === selectedCategory)?.title}</h2> : null}
              ...
              <div className={css.flip_card}>
                <div className={css.flip_card_inner}>
                  <div className={css.flip_card_front}>
                    <img className="card_img" src={backendBaseURL + landmark.landmark.image} alt={landmark.title} />
                  ...
                  <div className={css.flip_card_back}>
                    ...
                    <blockquote>
                      <p className={css.landmarkdesc}>{landmark.description ? truncateText(landmark.description, 300) : ''}</p>
                     
                    </blockquote>
                    <p>{t('LandMarksCards.From')} {landmark.category_type} </p>
                    <a className={css.read_more} onClick={() => { handleLandmarkClick(landmark); }}>
